...
*
*   This package is prepared and tested for the LPCXpresso54628 development board.
*
*******************************************************************************/
...
-------------------------------------------------------
  ...
  running on your LPC target, we have prepared a detailed article, which
...
How to build a demo using this template for the LPCXpresso54628 development board:
----------------------------------------------------------------------------------

  1.) Start Embedded Wizard Studio and open any project.
      Create a profile for the NXP LPC and make all settings so that
