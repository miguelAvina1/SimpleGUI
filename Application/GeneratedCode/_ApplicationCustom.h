...
#ifndef _ApplicationCustom_H
#define _ApplicationCustom_H
...
/* Forward declaration of the class Application::Custom */
...
EW_DEFINE_METHODS( ApplicationCustom, CoreGroup )
...
EW_END_OF_METHODS( ApplicationCustom )
