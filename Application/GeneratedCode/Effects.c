...
void EffectsBoolEffect__Init( EffectsBoolEffect _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( EffectsBoolEffect );
...
/* 'C' function for method : 'Effects::BoolEffect.OnSetNoOfCycles()' */
...
void EffectsBoolEffect_StartEffect( EffectsBoolEffect _this, XObject sender )
{
  ...
  EffectsBoolEffect_OnSetEnabled( _this, 1 );
}
...
EW_DEFINE_CLASS( EffectsBoolEffect, XObject, timer, privateOnFinished, Outlet, cycleCounter, 
