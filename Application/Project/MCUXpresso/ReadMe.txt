...
*   and link an Embedded Wizard generated application for a dedicated NXP LPC
*   target using NXP MCUXpresso.
*
*   This package is prepared and tested for the LPCXpresso54628 board.
*
*******************************************************************************/

Getting started with LPCXpresso54628 board:
-------------------------------------------
  In order to get your first Embedded Wizard generated UI application up and
  running on your NXP target, we have prepared a detailed article, which
...
- The following steps are needed to establish this automatic project import:
  ...
  * Select the profile and set the attribute PostProcess to the following file:
    ..\..\Application\Project\MCUXpresso\LPCXpresso54628\MCUXpresso_ew_post_process.cmd
...
- Import of the project to NXP MCUXpresso
  * The given NXP MCUXpresso Example under \Application\Project\MCUXpresso contains a
    ...
    3. Choose 'Select root directory' - 'Browse' and select the directory
       \Application\Project\MCUXpresso\LPCXpresso54628
    4. Press 'Finish'
...
- Usage of FreeRTOS:
  ...
  folder under 'ThirdParty->MCUXpressoSDK->rtos' and do a right click on it.
  The context menu under 'Resource Configuration->Exclude from Build' will give
  you the option to simply hide or unhide the FreeRTOS folders.

- If the color format or the screen orientation was changed, please do a
  clean and refresh in NXP MCUXpresso and build the project again.
